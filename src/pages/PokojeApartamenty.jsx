...
export default function PokojeApartamenty() {
  return (
    <>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            <div className="lg:col-span-7 reveal">
              <SectionHeading eyebrow="01 — O obiekcie" title={<>Rodzinny pensjonat <span className="italic font-normal">z 2019 roku</span>.</>} />
            ...
            {units.map((u, i) => (
              <article key={u.kind} className="reveal-lg card-lift group bg-cream rounded-sm overflow-hidden flex flex-col"
                ...
                <div className="relative overflow-hidden" style={{ aspectRatio: '4/3' }}>
                  <img src={u.img} alt={u.alt} loading="lazy" decoding="async"
                       width="1920" height="1440"
                       className="absolute inset-0 w-full h-full object-cover zoom-img" />
                </div>
                <div className="p-8 md:p-10 flex flex-col flex-1">
                  <div className="eyebrow text-charcoal/65 mb-2.5">{u.kind} · {u.sqm}</div>
                  <h3 className="font-serif text-charcoal text-3xl md:text-4xl leading-tight" style={{ fontWeight: 500 }}>{u.title}</h3>
      ...
      <section className="relative bg-cream py-20 md:py-28">
        <Container>
          <SectionHeading eyebrow="02 — Udogodnienia" title={<>Wszystko, czego trzeba <span className="italic font-normal">na miejscu</span>.</>} className="max-w-2xl mb-14 reveal" />
