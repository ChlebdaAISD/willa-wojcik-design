...
// Wypełniona gwiazdka do ocen — czysty glif bez cienkich złączeń stroke
export const IconStarFill = ({ size = 16, className = '' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24"
       fill="currentColor" stroke="none" className={className} aria-hidden="true">
